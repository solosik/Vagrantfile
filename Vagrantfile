...
Vagrant.configure(2) do |config|
  ...
  # accessing "localhost:8080" will access port 80 on the guest machine.
    ...
    config.vm.network "forwarded_port", guest: 22222, host: 22222 # To get access to PMA with ee
  ...
  # Hosts (hostupdater)
  config.vm.hostname = "www.styllex.dev"
  config.hostsupdater.aliases = ["styllex.dev", "test.styllex.dev"]
